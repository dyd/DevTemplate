/**
 * Created by dnatzkin on 8/10/2017.
 */
(function (window, document, $, undefined) {
    $(function () {
        ...
        $("#usr_frm").on("submit", function (e) {
            ...
            frmData.append("loginName", $('#loginName').val());
            frmData.append("modules", $("select[name='modules']").selectpicker('val'));
            frmData.append("status", $('input[name="status"]').bootstrapSwitch('state'));
            ...
            makeAjaxRequest(script, frmData,
                function (jdata) {
                    ...
                    if (jdata.st == '1') {
                        ...
                        showModal(success, successEdit, base_self);
